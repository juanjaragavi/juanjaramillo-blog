...
<img src="https://storage.googleapis.com/media.juanjaramillo.tech/la-etica-y-la-inteligencia-artificial-1.webp" alt="La ética en la Inteligencia Artificial" title="La ética en la Inteligencia Artificial" height="1280" width="853" style={{margin: '0 auto', borderRadius: '15px', border: '1px solid #ec4899' }} />
